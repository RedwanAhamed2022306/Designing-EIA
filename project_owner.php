...
<div class="navbar">
    ...
    <a href="project_analysis.php" class="btn btn-primary">Analysis</a>
    ...
    <table class="table table-striped">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<button type='submit' name='update_project' class='btn btn-primary'>Update</button>";
                echo "<button type='submit' name='delete_project' class='btn btn-danger'>Delete</button>";
                echo "</form>";
                echo "</td>";
                echo "</tr>";
            }
